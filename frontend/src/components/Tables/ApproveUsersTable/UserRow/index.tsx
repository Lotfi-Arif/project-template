// import { CheckOutline, XMarkOutline } from "@graywolfai/react-heroicons";
      ...
      <tr className="border-b border-gray-200 hover:bg-gray-100">
        <td className="py-3 px-6 text-left">
          <div className="flex items-center">
            ...
            <span>
              {users.user.firstNmae} <span> {users.user.lastName}</span>
            </span>
          </div>
        </td>
