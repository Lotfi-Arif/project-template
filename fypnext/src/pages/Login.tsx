            ...
            <div className="mx-auto bg-white shadow-lg mt-14 md:w-2/3 lg:w-2/3 sm:w-2/3 rounded-2xl">
                <div className="grid grid-cols-2 text-left">
                    <div className="row-start-auto my-auto mx-auto p-4">
                        ...
                        <div className="row-auto">
                            <form>
                                ...
                                <button type="submit" className="text-slate-500 hover:bg-sky-500 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Login</button>
                                <button type="submit" className='text-slate-500 hover:bg-gray-100 hover:text-black-300 bg-sky-500 hover:text-whitefont-bold p-1 px-2 ml-2 border rounded-sm'>
                                    Sign up
                                </button>
                            </form>
                        </div>
                    ...
                    <div className="row-start-auto my-auto mx-auto">
                        <Image src="/register.svg" width={723} height={723} />
                    </div>
                </div>
            </div>
        </>
