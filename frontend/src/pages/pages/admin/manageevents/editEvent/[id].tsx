          ...
          <div className="sm:max-w-lg w-full p-10 bg-white shadow-2xl rounded-xl z-10">
            ...
            <form className="mt-8 space-y-3" action="#" method="POST">
              ...
              <div className="grid grid-cols-1 space-y-2">
                ...
                <textarea
                  className="text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500"
                  placeholder={event?.eventDetails}
                  name={eventDetails}
                  onChange={(e) => {
              ...
              <div className="grid grid-cols-1 space-y-2">
                ...
                <input
                  className="text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500"
                  type="text"
                  placeholder={event?.eventImageURL}
                  name={eventImage}
                  onChange={(e) => {
              ...
              <div>
                <button
                  type="submit"
                  onClick={() =>
                    onUpdate({ id, title, eventDetails, eventImage })
                  }
                  className="my-5 w-full flex justify-center bg-sky-500 text-gray-100 p-4  rounded-full tracking-wide
