...
const Register = () => {
  ...
  const [signup] = useSignupMutation({
    onCompleted(data?) {
      ...
      console.log("Here is Json:", localStorage.getItem("user"), cookie);
    },
  });
      ...
      if (e.graphQLErrors[0].message.includes("ConflictException")) {
        toast(
          <Feedback
            ...
            subtitle={
              e.graphQLErrors[0]?.extensions?.exception?.meta?.cause ??
      ...
      <div className="container mx-auto">
        <div className="flex justify-center px-6 my-12">
          <div className="w-full shadow-lg xl:w-3/4 lg:w-11/12 flex">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex items-center mb-4">
                    <input
                      ...
                      value={Role.Student}
                      name="role"
                      className="w-4 h-4 ml-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                      onChange={(e) => {
            ...
            <div className=" h-auto w-auto lg:block sm:bg-cover bg-cover rounded-l-lg">
              <Image
                alt="RegisterPhoto"
                src="/register1.svg"
                width={841}
