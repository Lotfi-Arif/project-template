...
export class CounselorSessionsResolver {
  constructor(private readonly counselorSessionsService: CounselorSessionsService) {
  }

  @Query(() => CounselorSession)
  async findAllCounselorSessions(@Args() counselorSessionFindManyArgs: FindManyCounselorSessionArgs, @Info() info) {
    try {
      const counselorSessions = new PrismaSelect(info).value
      return this.counselorSessionsService.findAll({ ...counselorSessionFindManyArgs, ...counselorSessions })
    } catch (error) {
      console.error(error);
    }
  ...
  async findOneCounselorSession(@Args() counselorSessionFindUnique: FindUniqueCounselorSessionArgs, @Info() info) {
    try {
      const counselorSession = new PrismaSelect(info).value;
      return this.counselorSessionsService.findOne({ ...counselorSessionFindUnique, ...counselorSession })
    } catch (error) {
      console.error(error);
    }
  }
  ...
  @Mutation(() => CounselorSession)
  async createCounselorSession(@Args() counselorSessionCreateArgs: CreateOneCounselorSessionArgs, @Info() info) {
    try {
      const newCounselorSession = new PrismaSelect(info).value;
      return this.counselorSessionsService.createCounselorSession({ ...counselorSessionCreateArgs, ...newCounselorSession })
    } catch (error) {
      console.error(error);
    }
  }
  ...
  @Mutation(() => CounselorSession)
  async updateCounselorSession(@Args() counselorSessionUpdateArgs: UpdateOneCounselorSessionArgs, @Info() info) {
    try {
      const update = new PrismaSelect(info).value;
      return this.counselorSessionsService.updateCounselorSession({ ...counselorSessionUpdateArgs, ...update })
    } catch (error) {
      console.error(error);
    }
  ...
  @Mutation(() => CounselorSession)
  async deleteCounselorSession(@Args() counselorSessionDeletArgs: DeleteOneCounselorSessionArgs, @Info() info) {
    try {
      const counselorSession = new PrismaSelect(info).value;
      return this.counselorSessionsService.deleteCounselorSession({ ...counselorSessionDeletArgs, ...counselorSession })
    } catch (error) {
      console.error(error);
    }
  }
