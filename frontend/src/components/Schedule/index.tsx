            ...
            return (
              <>
                <span className="text-gray-900 relative inline-block date uppercase font-medium tracking-widest">
                  {moment(session?.counsellingDate).format("MM-DD")}
                </span>
                {console.log(
                  moment(session?.timeFrom).format("HH:MM"),
                  session?.timeFrom
                )}
                <div className="w-2/12">
                  ...
                  <span className="text-sm text-gray-600 block">
                    {moment(session?.timeTo).format("HH:MM")}
                  </span>
                </div>
                ...
                <div className="w-9/12">
                  <span className="text-sm font-semibold block">
                    Counselling with {session?.user?.firstName}{" "}
